        ...
        <Grid>
            ...
            PaperProps={{sx: { width: 500 }}}>
                <Box padding={2}>
                    ...
                    <Grid size={12} spacing={0} display="flex" alignItems="center" justifyContent="center" paddingBottom={5}>
                        <PriorityHighIcon size={4} style={{ fontSize: 64 }}></PriorityHighIcon>
                        <Typography size={8} sx={{fontStyle: 'bold', fontSize: 36}}>Guarantee for the new Berlin Warehouse Loan</Typography>
                    </Grid>
                    ...
                    <Grid container display="flex" paddingBottom={3}>
                        ...
                        <Grid size={6}>
                            <Button sx={{backgroundColor: "#DDA0DD", color: "white"}}>Approved</Button>
                        </Grid>
                    </Grid>
                    <Grid container display="flex" paddingBottom={3}>
                        <Grid size={6}>
                        ...
                        <Grid size={6}>
                            <Button sx={{backgroundColor: "#663399", color: "white"}}>Awaits Approval</Button>
                        </Grid>
                    </Grid>
